...
/* Template Name: CORREO*/


$p  = wp_mail("elbergjessica@gmail.com", "Ejemplo de la función mail en WP", "Este es un ejemplo del contenido de del mensaje de la funcion wp_mail() de WordPress");
$o = false ;
