    ...
    <div class="area-3">
        ...
        <section class="grid-2">
            ...
            <div class = "item1">
                            ...
                            <select id="estado" name="estado" class = "form-area" onchange="llenaMunicipio()">
...
<script language="JavaScript">
    ...
    function llenaMunicipio(){
        ...
        <?php   $id_state= "<script> document.write(mun) </script>";
        $arrayMunResult = read_municipalt($id_state);
        ?>
    }
