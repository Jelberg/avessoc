...
drop table if exists DISIEASE;

drop table if exists EXAM;

drop table if exists MDCENTER;

drop table if exists MUNICIPALT;
...
drop table if exists RCENTEREXAM;

drop table if exists REQUEST;

drop table if exists RPERNOT;

drop table if exists RPORDER;
...
(
   ...
   CONFIG_ACTIVITY_DATE timestamp not null,
   CONFIG_USER          text,
...
(
   ...
   CONTACT_ACTIVITY_DATE timestamp not null,
   CONTACT_USER         text,
...
(
   ...
   DIRECTION_PAR_MUN_ST_ID int not null,
...
(
   ...
   DISIEASE_DESC        text,
   DISIEASE_ACTIVITY_DATE timestamp not null,
   DISIEASE_USER        text,
...
(
   ...
   EXAM_ACTIVITY_DATE   timestamp not null,
   EXAM_USER            text,
   primary key (EXAM_ID)
);
...
(
   ...
   MPERSON_IDENTF       int,
   MPERSON_ACTIVITY_DATE timestamp,
   MPERSON_USER         text,
...
(
   ...
   MUNICIPALT_ACTIVITY_DATE timestamp not null,
...
(
   ...
   NOTIFICATION_ACTIVITY_DATE timestamp not null,
...
(
   ...
   ORDER_ACTIVITY_DATE  timestamp not null,
   ORDER_USER           text,
...
(
   ...
   PARISH_DESC          text,
   PARISH_ACTIVITY_DATE timestamp not null,
   PARISH_USER          text,
...
(
   ...
   MPERSON_ACTIVITY_DATE timestamp not null,
   MPERSON_USER         text,
   MPERSON_SECOND_NAME  text,
   MPERSON_SECOND_LNAME text,
   MPERSON_NACIONALITY  text,
...
(
   ...
   REQUEST_ORIGIN       text,
   REQUEST_ACTIVITY_DATE timestamp not null,
   REQUEST_USER         text,
...
(
   ...
   RPORDER_ACTIVITY_DATE timestamp not null,
   RPORDER_USER         text,
