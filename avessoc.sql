...
ALTER TABLE `MDCENTER` ADD `MDCENTER_RESPANSABILITY_EMAIL` TEXT NULL AFTER `MDCENTER_LLABOR_DAY`;

ALTER TABLE `CONTACT` DROP FOREIGN KEY `FK_CONTACT_INV_MDCENTER_ID`; ALTER TABLE `CONTACT` ADD CONSTRAINT `FK_CONTACT_INV_MDCENTER_ID` FOREIGN KEY (`CONTACT_MDC_MPERSON_ID`) REFERENCES `MDCENTER`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT; ALTER TABLE `CONTACT` DROP FOREIGN KEY `FK_CONTACT_INV_PATIENT_ID`; ALTER TABLE `CONTACT` ADD CONSTRAINT `FK_CONTACT_INV_PATIENT_ID` FOREIGN KEY (`CONTACT_MPERSON_ID`) REFERENCES `PATIENT`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT; ALTER TABLE `CONTACT` DROP FOREIGN KEY `FK_CONTACT_INV_USER_ID`; ALTER TABLE `CONTACT` ADD CONSTRAINT `FK_CONTACT_INV_USER_ID` FOREIGN KEY (`CONTACT_USER_MPERSON_ID`) REFERENCES `USER`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `DIRECTION` DROP FOREIGN KEY `FK_DIRECTION_INV_MDCENTER_ID`;
ALTER TABLE `DIRECTION` ADD  CONSTRAINT `FK_DIRECTION_INV_MDCENTER_ID` FOREIGN KEY (`DIRECTION_MDC_MPERSON_ID`) REFERENCES `MDCENTER`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;
ALTER TABLE `DIRECTION` DROP FOREIGN KEY `FK_DIRECTION_INV_PARISH_ID`;
ALTER TABLE `DIRECTION` ADD  CONSTRAINT `FK_DIRECTION_INV_PARISH_ID` FOREIGN KEY (`DIRECTION_PARISH_ID`, `DIRECTION_PAR_MUN_ID`) REFERENCES `PARISH`(`PARISH_ID`, `PARISH_MUNICIPALT_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;
ALTER TABLE `DIRECTION` DROP FOREIGN KEY `FK_DIRECTION_INV_PATIENT_ID`;
ALTER TABLE `DIRECTION` ADD  CONSTRAINT `FK_DIRECTION_INV_PATIENT_ID` FOREIGN KEY (`DIRECTION_MPERSON_ID`) REFERENCES `PATIENT`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;
ALTER TABLE `DIRECTION` DROP FOREIGN KEY `FK_DIRECTION_INV_USER_ID`;
ALTER TABLE `DIRECTION` ADD  CONSTRAINT `FK_DIRECTION_INV_USER_ID` FOREIGN KEY (`DIRECTION_USE_MPERSON_ID`) REFERENCES `USER`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `RCENTEREXAM` DROP FOREIGN KEY `FK_RCENTEREXAM_INV_EXAM_ID`; ALTER TABLE `RCENTEREXAM` ADD CONSTRAINT `FK_RCENTEREXAM_INV_EXAM_ID` FOREIGN KEY (`RCENTEREXAM_EXAM_ID`) REFERENCES `EXAM`(`EXAM_ID`) ON DELETE CASCADE ON UPDATE RESTRICT; ALTER TABLE `RCENTEREXAM` DROP FOREIGN KEY `FK_RCENTEREXAM_INV_MDCENTER_ID`; ALTER TABLE `RCENTEREXAM` ADD CONSTRAINT `FK_RCENTEREXAM_INV_MDCENTER_ID` FOREIGN KEY (`RCENTEREXAM_MDCENTER_PERSON_ID`) REFERENCES `MDCENTER`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `REQUEST` DROP FOREIGN KEY `FK_REQUEST_INV_MDCENTER_CONCERNING`; ALTER TABLE `REQUEST` ADD CONSTRAINT `FK_REQUEST_INV_MDCENTER_CONCERNING` FOREIGN KEY (`REQUEST_MDCENTER_ID_REFERRED`) REFERENCES `MDCENTER`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT; ALTER TABLE `REQUEST` DROP FOREIGN KEY `FK_REQUEST_INV_MECENTER_REFERRED`; ALTER TABLE `REQUEST` ADD CONSTRAINT `FK_REQUEST_INV_MECENTER_REFERRED` FOREIGN KEY (`REQUEST_MDCENTER_ID_CONCERNING`) REFERENCES `MDCENTER`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT; ALTER TABLE `REQUEST` DROP FOREIGN KEY `FK_REQUEST_INV_PATIENT_ID`; ALTER TABLE `REQUEST` ADD CONSTRAINT `FK_REQUEST_INV_PATIENT_ID` FOREIGN KEY (`REQUEST_PATIENT_PERSON_ID`) REFERENCES `PATIENT`(`MPERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `RPORDER` DROP FOREIGN KEY `FK_RPORDER_INV_ORDER_ID`; ALTER TABLE `RPORDER` ADD CONSTRAINT `FK_RPORDER_INV_ORDER_ID` FOREIGN KEY (`RPORDER_ORDER_ID`) REFERENCES `ORD`(`ORDER_ID`) ON DELETE CASCADE ON UPDATE RESTRICT; ALTER TABLE `RPORDER` DROP FOREIGN KEY `FK_RPORDER_INV_RCENTEREXAM_ID`; ALTER TABLE `RPORDER` ADD CONSTRAINT `FK_RPORDER_INV_RCENTEREXAM_ID` FOREIGN KEY (`RPORDER_CE_ID`) REFERENCES `RCENTEREXAM`(`RCENTEREXAM_ID`) ON DELETE CASCADE ON UPDATE RESTRICT; ALTER TABLE `RPORDER` DROP FOREIGN KEY `FK_RPORDER_INV_REQUEST_ID`; ALTER TABLE `RPORDER` ADD CONSTRAINT `FK_RPORDER_INV_REQUEST_ID` FOREIGN KEY (`RPORDER_REQUEST_ID`, `REQUEST_PATIENT_PERSON_ID`) REFERENCES `REQUEST`(`REQUEST_ID`, `REQUEST_PATIENT_PERSON_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `EXAM` ADD `EXAM_DISIEASE` TEXT NULL AFTER `EXAM_USER`;

ALTER TABLE `USER` CHANGE `MPERSON_BIRTH` `MPERSON_BIRTH` DATE NULL, CHANGE `MPERSON_IDENTF` `MPERSON_IDENTF` INT(11) NULL, CHANGE `MPERSON_LEGAL_NAME` `MPERSON_LEGAL_NAME` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL, CHANGE `MPERSON_TYPE_DOC` `MPERSON_TYPE_DOC` CHAR(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL;

ALTER TABLE `USER` CHANGE `USER_PASS` `USER_PASS` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL, CHANGE `USER_PSEUDONYM` `USER_PSEUDONYM` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL, CHANGE `USER_PRIVILEGE_LEVL` `USER_PRIVILEGE_LEVL` CHAR(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL;
ALTER TABLE `ORD` ADD `ORDER_GRAFFAR` INT NULL AFTER `ORDER_USER`;

ALTER TABLE `RPORDER` ADD `RPORDER_EXAM_PRICE` FLOAT(10,3) NULL AFTER `RPORDER_NUMERO_SOL`;

ALTER TABLE `ORD` DROP `ORDER_PRICE_EXAM`;